#!/bin/bash
#############################################################################
# START_EXPERIMENT.sh - Experiment 3 Setup and Execution
# This script sets up the environment and runs Experiment 3 automatically
#############################################################################

set -e  # Exit on any error

echo "=========================================="
echo "🚀 Starting Experiment 3 Setup"
echo "=========================================="
echo ""
...
export DB_PATH="${DB_PATH:-exp3_results.db}"
export LOG_FILE="${LOG_FILE:-exp3_execution.log}"
export OUTPUT_DIR="${OUTPUT_DIR:-exp3_results}"

echo "=========================================="
echo "⚙️  Experiment 3 Configuration"
echo "=========================================="
echo "Trials:          $TRIALS"
...
echo "=========================================="
echo ""
echo "This will run experiment 3 with $TRIALS trials..."
